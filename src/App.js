...
function App() {
  const createStory = () => {
    return [
      ...
      {id: 3, title: "Manter usuário", content: "Eu como usuário quero manter uma conta no sistema", layer_id: -1},
      {id: 4, title: "Manter projeto", content: "Eu como usuário quero manter vários projetos ", layer_id: -1},
    ];
  }
